...
static char knee_sensor_interface__msg__KneeSensor__TYPE_NAME[] = "knee_sensor_interface/msg/KneeSensor";
...
static rosidl_runtime_c__type_description__Field knee_sensor_interface__msg__KneeSensor__FIELDS[] = {
  {
    {knee_sensor_interface__msg__KneeSensor__FIELD_NAME__header, 6, 6},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription knee_sensor_interface__msg__KneeSensor__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *knee_sensor_interface__msg__KneeSensor__get_individual_type_description_source(NULL),
