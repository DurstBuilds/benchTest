...
static rosidl_typesupport_introspection_c__MessageMember knee_sensor_interface__msg__KneeSensor__rosidl_typesupport_introspection_c__KneeSensor_message_member_array[2] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(knee_sensor_interface__msg__KneeSensor, active),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
