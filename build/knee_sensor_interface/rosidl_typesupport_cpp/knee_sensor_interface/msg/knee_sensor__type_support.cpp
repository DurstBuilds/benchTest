...
static const _KneeSensor_type_support_symbol_names_t _KneeSensor_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, knee_sensor_interface, msg, KneeSensor)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, knee_sensor_interface, msg, KneeSensor)),
  }
};
...
{
  return &::knee_sensor_interface::msg::rosidl_typesupport_cpp::KneeSensor_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, knee_sensor_interface, msg, KneeSensor)() {
  return get_message_type_support_handle<knee_sensor_interface::msg::KneeSensor>();
}
