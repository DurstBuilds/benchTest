...
bool knee_sensor_interface__msg__knee_sensor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("knee_sensor_interface.msg._knee_sensor.KneeSensor", full_classname_dest, 49) == 0);
  }
  knee_sensor_interface__msg__KneeSensor * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of KneeSensor */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("knee_sensor_interface.msg._knee_sensor");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "KneeSensor");
